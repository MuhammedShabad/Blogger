                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="phone" required maxlength="10" minlength="10">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label"><?php echo $a." + ".$b ?></label>
                                    <input class="input--style-4" type="text" name="ans" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
