		...
		<div class="card text-dark col-sm-6 col-xs-12 col-md-3">
			...
			if($result['p_image']!=''){ ?>
  			...
  			<div class="card-footer text-dark">
    			<p class="card-text"><i class="fa fa-thumbs-up count<?php echo $result['p_id'];?>" onclick="like(<?php echo $result['p_id'];?>)"><?php echo $result2['c'];?></i><button class="btn-sm btn-primary"  data-toggle="modal" data-target="#myModal<?php echo $result['p_id'];?>">Comment</button><button style="float: right;" class="btn btn-info" onclick="fullpost(<?php echo $result['p_id'];?>)">Read More</button></p>
			</div>
